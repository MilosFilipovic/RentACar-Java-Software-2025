...
public interface Operacije {
    ...
    public static final int VRATI_ZAPOSLENE = 2;
    public static final int DODAJ_ZAPOSLENOG = 3;
    ...
    public static final int DODAJ_ZRS = 12;
    public static final int POPUNI_ZRS = 13;
    public static final int OBRISI_ZRS = 14;
    
    public static final int VRATI_MESTA = 15;
    public static final int DODAJ_MESTO = 16;
    ...
    public static final int DODAJ_KLIJENTA = 21;
    ...
    public static final int DODAJ_VOZILO = 24;
    ...
    public static final int KREIRAJ_REZERVACIJU = 33;
    public static final int OBRISI_REZERVACIJU = 37;
    public static final int PRETRAZI_REZERVACIJE = 38;
